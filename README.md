## PHP ООП.
## Урок 5. Ключевые слова $this, self, static

#### Необходимо:
1. Ознакомиться с предыдущими уроками

#### Ход урока:
1. Перейдите на ветку пятого урока командой ```git checkout lesson5 --force```
2. Изучите файл **index.php**, обратите внимание на ключевые слова
3. Чем отличается **$this** от **self**?
4. Можно ли обратиться к статическому свойству класса через созданный объект? Проверьте!
5. Что такое позднее статическое связывание? (легче будет понять после Урока 9 )
6. Проделайте пару экспериментов и переходите к [уроку 6. Магические методы (__construct(), __invoke()... )](https://github.com/altiore/mm/tree/lesson6)
